...
const SIDEBAR_LINKS = [
  ...
  { to: '/roadmap',      iconKey: 'roadmap',   label: 'Career Roadmap' },
  { to: '/analytics',    iconKey: 'analytics', label: 'Analytics' },
  { to: '/twin',         iconKey: 'twin',      label: 'AI Career Twin' },
  { to: '/recruiter',    iconKey: 'recruiter', label: 'Recruiter Arena' },
  { to: '/trends',       iconKey: 'trends',    label: 'Trend Radar' },
    ...
    <aside className="sidebar">
      ...
      <div className="sidebar__inner">
        ...
        <div className="sidebar__footer">
          <a
            href="/"
            onClick={() => localStorage.removeItem('cc_user')}
            className="sidebar__link"
            style={{ minHeight: 'auto', padding: '4px 0', border: 'none', background: 'transparent' }}
          >
            <span className="sidebar__icon">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
